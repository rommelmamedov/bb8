!(function(e, t) {
  ...
  var d = (function(n) {
    ...
    (oe.matchesSelector = function(e, t) {
      if (((e.ownerDocument || e) !== C && T(e), (t = t.replace(U, "='$1']")), d.matchesSelector && E && !A[t + ' '] && (!c || !c.test(t)) && (!v || !v.test(t))))
        try {
          var n = y.call(e, t);
      ...
      for (
        ...
        if ((t = b.relative[e[s].type])) c = [me(xe(c), t)];
          ...
          if ((t = b.filter[e[s].type].apply(null, e[s].matches))[k]) {
            ...
            return we(1 < s && xe(c), 1 < s && ye(e.slice(0, s - 1).concat({ value: ' ' === e[s - 2].type ? '*' : '' })).replace(_, '$1'), t, s < n && Te(e.slice(s, n)), n < r && Te((e = e.slice(n))), n < r && ye(e));
          }
          c.push(t);
        }
      return xe(c);
    ...
    return (
      ...
      (h = oe.tokenize = function(e, t) {
        ...
        for (a = e, s = [], u = b.preFilter; a; ) {
          for (o in ((n && !(r = z.exec(a))) || (r && (a = a.slice(r[0].length) || a), s.push((i = []))), (n = !1), (r = X.exec(a)) && ((n = r.shift()), i.push({ value: n, type: r[0].replace(_, ' ') }), (a = a.slice(n.length))), b.filter))
  ...
  ((k.fn.init = function(e, t, n) {
    ...
    if (r[1]) {
      if (((t = t instanceof k ? t[0] : t), k.merge(this, k.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : E, !0)), N.test(r[1]) && k.isPlainObject(t))) for (r in t) x(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
      return this;
    }
                  ...
                  function e() {
                    ...
                    if (!(i < u)) {
                      ...
                      (t = e && ('object' == typeof e || 'function' == typeof e) && e.then),
                        x(t) ? (s ? t.call(e, l(u, o, M, s), l(u, o, R, s)) : (u++, t.call(e, l(u, o, M, s), l(u, o, R, s), l(u, o, M, o.notifyWith)))) : (a !== M && ((n = void 0), (r = [e])), (s || o.resolveWith)(n, r));
                    }
                  }
                  var n = this,
                    r = arguments,
  ...
  function Ge(e, t, n) {
    ...
    return (
      (n = n || ze(e)) &&
        ...
        !m.pixelBoxStyles() && _e.test(a) && Xe.test(t) && ((r = s.width), (i = s.minWidth), (o = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = r), (s.minWidth = i), (s.maxWidth = o))),
      void 0 !== a ? a + '' : a
    );
  }
  function Ye(e, t) {
      ...
      k.cssHooks[s] = {
        ...
        set: function(e, t, n) {
          var r,
            ...
            a = n && it(e, s, n, o, i);
          return (
            o && m.scrollboxSize() === i.position && (a -= Math.ceil(e['offset' + s[0].toUpperCase() + s.slice(1)] - parseFloat(i[s]) - it(e, s, 'border', !1, i) - 0.5)),
  ...
  (k.Animation = k.extend(yt, {
    ...
    (k.speed = function(e, t, n) {
      var r = e && 'object' == typeof e ? k.extend({}, e) : { complete: n || (!n && t) || (x(e) && e), duration: e, easing: (n && t) || (t && !x(t) && t) };
      return (
    ...
    k.each({ slideDown: gt('show'), slideUp: gt('hide'), slideToggle: gt('toggle'), fadeIn: { opacity: 'show' }, fadeOut: { opacity: 'hide' }, fadeToggle: { opacity: 'toggle' } }, function(e, r) {
      ...
      attr: function(e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute
            ? k.prop(e, t, n)
            : ((1 === o && k.isXMLDoc(e)) || (i = k.attrHooks[t.toLowerCase()] || (k.expr.match.bool.test(t) ? mt : void 0)),
              void 0 !== n ? (null === n ? void k.removeAttr(e, t) : i && 'set' in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ''), n)) : !(i && 'get' in i && null !== (r = i.get(e, t))) && null == (r = k.find.attr(e, t)) ? void 0 : r);
      },
      attrHooks: {
        type: {
          set: function(e, t) {
    ...
    k.fn.extend({
      ...
      toggleClass: function(i, t) {
        ...
        return 'boolean' == typeof t && a
          ...
          : this.each(function() {
              var e, t, n, r;
              if (a) for (t = 0, n = k(this), r = Et(i); (e = r[t++]); ) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
        ...
        return (
          ...
          r ||
            ...
            (u &&
              x(n[d]) &&
              !g(n) &&
              ((a = n[u]) && (n[u] = null), (k.event.triggered = d), e.isPropagationStopped() && f.addEventListener(d, St), n[d](), e.isPropagationStopped() && f.removeEventListener(d, St), (k.event.triggered = void 0), a && (n[u] = a))),
          e.result
        );
      }
    },
      ...
      ajax: function(e, t) {
        ...
        v.hasContent
          ...
          : ((o = v.url.slice(f.length)),
            v.data && (v.processData || 'string' == typeof v.data) && ((f += (jt.test(f) ? '&' : '?') + v.data), delete v.data),
            !1 === v.cache && ((f = f.replace(It, '$1')), (o = (jt.test(f) ? '&' : '?') + '_=' + At++ + o)),
            (v.url = f + o)),
  ...
  k.ajaxSetup({
    ...
    (m.createHTMLDocument = (((Jt = E.implementation.createHTMLDocument('').body).innerHTML = '<form></form><form></form>'), 2 === Jt.childNodes.length)),
